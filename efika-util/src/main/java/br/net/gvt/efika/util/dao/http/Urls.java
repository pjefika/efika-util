...
public enum Urls {
    ...
    CUSTOMERAPI_CADASTRO("http://localhost:9001/customerAPI/customer/findByParameter"),
    CUSTOMERAPI_CERTIFICATION("http://localhost:9001/customerAPI/certification/execByParam"),
    CUSTOMERAPI_CONF_REDE("http://localhost:9001/customerAPI/certification/confRede"),
    CUSTOMERAPI_ONTS_DISP("http://localhost:9001/customerAPI/certification/ontsDisp"),
    CUSTOMERAPI_SET_ONT("http://localhost:9001/customerAPI/certification/setOntToOlt"),
