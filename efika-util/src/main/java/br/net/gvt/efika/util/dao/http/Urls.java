 ...
 * and 10.40.196.171open the template in the editor.
 */
...
public enum Urls {
    ...
    ASSIA_CLEARVIEW_STEALER("http://10.40.196.171:7173/stealerAPI/assia/clearViewRealTime"),
    ...
    ACSAPI_ACTIVATE_WIFI("http://10.40.196.171:7177/acsAPI/device/activateWifi"),
    ...
    ACSAPI_GET_INTERFACE_STATISTICS("http://10.40.196.171:7177/acsAPI/device/getInterfaceStatistics"),
    ACSAPI_GET_XDSL_STATISTICS("http://10.40.196.171:7177/acsAPI/device/getXdslDiagnostic"),
    ACSAPI_GET_PPPOE_CRED("http://10.40.196.171:7177/acsAPI/device/getPPPoECredentials"),
    ACSAPI_SET_PPPOE_CRED("http://10.40.196.171:7177/acsAPI/device/setPPPoECredentials"),
    ACSAPI_GET_PORT_MAPPING("http://10.40.196.171:7177/acsAPI/device/getPortMapping"),
    ACSAPI_REBOOT("http://10.40.196.171:7177/acsAPI/device/reboot"),
    ACSAPI_FACTORY_RESET("http://10.40.196.171:7177/acsAPI/device/factoryReset"),
    ACSAPI_PING("http://10.40.196.171:7177/acsAPI/device/pingDiagnostic"),
    ACSAPI_GET_DHCP("http://10.40.196.171:7177/acsAPI/device/getDhcp"),
    ACSAPI_SET_DHCP("http://10.40.196.171:7177/acsAPI/device/setDhcp"),
    ACSAPI_GET_DDNS("http://10.40.196.171:7177/acsAPI/device/getDdns"),
    ACSAPI_GET_SERVICE_CLASS("http://10.40.196.171:7177/acsAPI/device/getServiceClass"),
    ...
    ACSAPI_GET_IPTV_DIAGNOSTICS("http://10.40.196.171:7177/acsAPI/device/getIptvDiagnostics");
