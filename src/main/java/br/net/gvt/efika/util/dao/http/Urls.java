...
//    QUEUE_CONSUME_TASKS("http://54.94.208.183:8080/queueAPI/queue/consumePendingTasks"),
    QUEUE_COMPLETE_TASK("http://localhost:8080/task/complete"),
    QUEUE("http://localhost:8080/task/complete"),
    QUEUE_CONSUME_TASKS("http://localhost:8080/task/consume_10"),
    SERVICE_INVENTORY("http://localhost:7180/stealerAPI/serviceInventory/"),
    NETWORK_INVENTORY("http://localhost:7180/stealerAPI/networkInventory/"),
    CADASTRO_STEALER("http://localhost:7180/stealerAPI/oss/"),
    STEALER_MANOBRA_ASSERTS("http://localhost:7180/stealerAPI/manobra/asserts"),
    LIST_STB_STEALER("http://localhost:7180/stealerAPI/confOnline/listStbs"),
    DIAGNOSTICO_HPNA_STEALER("http://localhost:7180/stealerAPI/confOnline/diagnosticoHpna"),
    ASSIA_CLEARVIEW_STEALER("http://localhost:7180/stealerAPI/assia/clearViewRealTime"),
    ...
    FULLTEST_MANOBRA("http://localhost:7172/fulltestAPI/fulltest/manobra"),
    FULLTEST_MANOBRA_ASSERTS("http://localhost:7172/fulltestAPI/manobra/asserts"),
    FULLTEST_ANALITICO("http://localhost:7172/fulltestAPI/manobra/analitico"),
    ...
    CUSTOMERAPI_CADASTRO("http://localhost:7179/customerAPI/customer/findByParameter"),
    CUSTOMERAPI_HPNA("http://localhost:7179/customerAPI/customer/findByParameterTv"),
    CUSTOMERAPI_CERTIFICATION("http://localhost:7179/customerAPI/certification/execByParam"),
    CUSTOMERAPI_CONF_REDE("http://localhost:7179/customerAPI/certification/confRede"),
    CUSTOMERAPI_ONTS_DISP("http://localhost:7179/customerAPI/certification/ontsDisp"),
    CUSTOMERAPI_SET_ONT("http://localhost:7179/customerAPI/certification/setOntToOlt"),
